# NBSVM implementation adapted from https://github.com/Joshua-Chin/nbsvm
...
class NBSVM(BaseEstimator, LinearClassifierMixin, SparseCoefMixin):
    ...
    def __init__(self, alpha=1, C=1, beta=0.25, fit_intercept=False, random_state=0, class_weight=None, max_iter = 1000):
        self.alpha = alpha
        self.C = C
        self.beta = beta
